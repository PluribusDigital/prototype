...
controllers.controller("KioskController", ['$scope', '$routeParams', '$location', '$resource', '$http', 'TimelineInitializer',
function ($scope, $routeParams, $location, $resource, $http, TimelineInitializer) {
      /************************************************************************************************
